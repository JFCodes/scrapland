import type {
  T_Task_Ad_Housing_FindNew_Insert,
...
export type T_API_PAYLOAD_Task_Housing_FindNEw_Patch = T_Task_Ad_Housing_FindNew_Patch

export type T_API_PAYLOAD_Task_Vehicle_FindNEw_Create = T_Task_Ad_Vehicle_FindNew_Insert
